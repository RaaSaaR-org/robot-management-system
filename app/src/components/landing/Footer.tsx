      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex gap-4">
              <a href="https://github.com/RaaSaaR-org/robot-management-system" target="_blank" rel="noopener noreferrer" className="text-theme-muted hover:text-theme-primary transition-colors">
        ...
        <div className="mt-12 pt-8 border-t border-theme flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-4 text-theme-muted text-sm">
            <a href="https://github.com/RaaSaaR-org/robot-management-system" target="_blank" rel="noopener noreferrer" className="hover:text-theme-primary transition-colors">Open Source Software</a>
          </div>
        </div>
      </div>
    </footer>
