  ...
  return (
    <section id="contact" className="py-24 bg-gradient-to-br from-cobalt via-cobalt-600 to-midnight-blue relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-turquoise/20 rounded-full blur-3xl" />
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-10">
          <a
            ...
            className="px-8 py-3 bg-white text-cobalt font-semibold rounded-brand hover:bg-soft-white transition-colors inline-flex items-center justify-center gap-2"
          >
