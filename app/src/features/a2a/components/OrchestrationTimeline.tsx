    ...
    <div className={cn('flex justify-start', className)}>
      ...
      >
        ...
        <div className="flex items-center gap-2 mb-2">
          <svg className="w-3.5 h-3.5 text-[#FF6700]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            <path strokeLinecap="round" strokeLinejoin="round" d="M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09zM18.259 8.715L18 9.75l-.259-1.035a3.375 3.375 0 00-2.455-2.456L14.25 6l1.036-.259a3.375 3.375 0 002.455-2.456L18 2.25l.259 1.035a3.375 3.375 0 002.455 2.456L21.75 6l-1.036.259a3.375 3.375 0 00-2.455 2.456z" />
          </svg>
          <span className="text-[10px] font-semibold tracking-wider uppercase text-[#FF6700]">
            Orchestrator
          </span>
        </div>
        ...
        <div className="space-y-1.5">
            ...
            return (
              <div key={`${s.step}-${i}`} className="flex items-start gap-2">
                ...
                <div className="flex flex-col items-center pt-0.5">
                  ...
                  />
                  {i < steps.length - 1 && (
                    <div className="w-px h-3 mt-0.5" style={{ background: 'rgba(255, 103, 0, 0.2)' }} />
                  )}
                </div>
                ...
                <div className="flex items-center gap-1.5 min-w-0">
                  ...
                  {s.step === 'forwarding' && s.agentName && (
                    <span className="text-[10px] font-mono px-1.5 py-0.5 rounded bg-blue-50 dark:bg-blue-900/20 text-blue-500">
                      → {s.agentName}
                    </span>
                  )}
                </div>
          ...
          {isComplete && (
            <div className="flex items-start gap-2">
              <div className="flex flex-col items-center pt-0.5">
                <span className="w-2 h-2 rounded-full flex-shrink-0 animate-pulse" style={{ background: '#FF6700' }} />
              </div>
              <span className="text-xs text-gray-500 dark:text-gray-400">
