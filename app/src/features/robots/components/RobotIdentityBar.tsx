  ...
  return (
    ...
    >
      ...
      {onBack && (
        <button
          ...
          className={cn(
            ...
            'hover:bg-[rgba(42,95,255,0.08)] transition-colors duration-150'
          )}
        >
      ...
      <div
        ...
        style={{ background: 'rgba(42,95,255,0.1)', border: '1px solid rgba(42,95,255,0.2)' }}
      >
        <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="#2A5FFF" strokeWidth={1.5}>
