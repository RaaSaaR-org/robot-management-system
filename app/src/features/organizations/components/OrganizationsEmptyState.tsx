...
export function OrganizationsEmptyState({
  ...
  return (
    <div className="rounded-brand border border-dashed border-theme bg-theme-card p-10 text-center">
      <div className="mx-auto w-14 h-14 rounded-brand bg-cobalt/10 text-cobalt flex items-center justify-center mb-4">
      ...
      <p className="text-sm text-theme-secondary max-w-md mx-auto mb-6">
        Row-level multi-tenancy is active. Create your first customer organization
        to see isolated robots, datasets, and training jobs in action.
      </p>
