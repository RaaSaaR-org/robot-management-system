...
export const PlannerBlockKinds = AgentBlockKinds.filter(
  (k): k is Exclude<AgentBlockKind, (typeof PatrolOnlyBlockKinds)[number]> =>
    !(PatrolOnlyBlockKinds as readonly string[]).includes(k),
) as unknown as readonly [Exclude<AgentBlockKind, (typeof PatrolOnlyBlockKinds)[number]>, ...Exclude<AgentBlockKind, (typeof PatrolOnlyBlockKinds)[number]>[]];
