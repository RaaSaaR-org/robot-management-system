...
# NeoDEM: factory hall + walled pause room + apple/plate pick-and-place.
from . import factory_pause_room_g1_29dof_dex3_wholebody
...
__all__ = [
        ...
        "factory_pause_room_g1_29dof_dex3_wholebody"
]
